...
if(isset($_POST['username'])){
    ...
    set_message( ' You are registered sucessfully! Kindly log in now.');
...
<div class="container mt-5">
  <div class="row justify-content-center">
    ...
    <h1 class="display-1"><font size = "10" style="font-family: verdana"><b><center>Register</center></b></font></h1>
    <div class="col-md-4">
